...
export const Features = () => {
  return (
    <>
      ...
      <section className="bg-white light:bg-gray-900 md:px-0 px-5" data-aos="fade-up">
        <div className="py-8 mx-auto max-w-screen-xl sm:py-16 ">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-9 mt-20 md:space-y-0 text-black">
            <div className='bg-[#f1e9fc] p-6 space-y-4 rounded-3xl drop-shadow-lg hover:-translate-y-8 hover:shadow-lg duration-200 ease-in-out cursor-pointer ' data-aos="fade-up"  data-aos-delay="100"     >
            ...
            <div className='bg-[#f1e9fc] p-6 space-y-4 drop-shadow-lg hover:-translate-y-8 hover:shadow-lg duration-200 ease-in-out cursor-pointer  rounded-3xl' data-aos="fade-up"  data-aos-delay="400">
              <div className="flex justify-center items-center mb-4 w-10 h-10  lg:h-12 lg:w-12 light:bg-pink-900">
            ...
            <div className='bg-[#f1e9fc] p-6 space-y-4 drop-shadow-lg hover:-translate-y-8 hover:shadow-lg duration-200 ease-in-out cursor-pointer  rounded-3xl' data-aos="fade-up"  data-aos-delay="500">
            ...
            <div className='bg-[#f1e9fc] p-6 space-y-4 drop-shadow-lg hover:-translate-y-8 hover:shadow-lg duration-200 ease-in-out cursor-pointer  rounded-3xl ' data-aos="fade-up"  data-aos-delay="1000" >
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-pink-100 lg:h-12 lg:w-12 light:bg-pink-900">
